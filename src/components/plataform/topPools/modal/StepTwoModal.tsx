  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <input
        ...
        className="w-full rounded-xl px-4 py-2 border border-white/20 bg-transparent placeholder-white/50"
      />
      ...
      <div className="flex gap-2">
        {slippageOptions.map((option) => (
          <button
            ...
            className={`flex-1 border py-1 rounded-xl text-sm transition ${
      ...
      {isCustomSlippage && (
        <input
          ...
          className="mt-2 w-full rounded-xl px-4 py-2 border border-white/20 bg-transparent placeholder-white/50"
        />
      )}
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <button
          onClick={handleNext}
          disabled={!isValid}
          className={`py-2 px-6 rounded-xl font-medium transition ${
