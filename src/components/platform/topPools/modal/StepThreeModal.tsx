...
export default function LiquidityStepThree({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white/5 p-4 rounded-xl text-sm flex flex-col gap-2">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={onConfirm}
          className="py-2 px-6 rounded-xl bg-teal-500 hover:bg-teal-600 transition font-medium"
        >
          Create Position
        </button>
      </div>
